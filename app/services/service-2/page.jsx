      ...
      <div className="w-full bg-[#ffffff]">
        ...
        <section className="p-[140px_20px_80px] bg-[#ffffff] max-[1024px]:!p-[80px_24px_60px] max-[425px]:!p-[60px_16px_40px] max-[1024px]:!overflow-hidden">
          <ScrollReveal direction="up">
            ...
            <div className="flex flex-col min-[1025px]:flex-row gap-[24px] min-[1025px]:gap-[20px] w-full min-[1025px]:w-[1230px] h-auto opacity-100 max-[1024px]:!w-full max-[1024px]:!h-auto max-[1024px]:!gap-[23px] max-[1024px]:!items-center">
              {/* Column 1 (2 Cards) */}
              <div className="flex flex-col gap-[24px] w-full min-[1025px]:w-[379px] h-auto">
                {capabilityCards.slice(0, 2).map((card, idx) => (
                  <article
                    key={card.id}
                    className={`${baseCardClass} ${card.cardClass || ""} service-card-anim card-entrance flex-1 h-full`}
              ...
              {/* Column 3 (1 Big Card) */}
              <div className="w-full min-[1025px]:w-[428px] relative flex flex-col">
                <article
                  className={`${baseCardClass} ${capabilityCards[4].cardClass || ""} flex-1 h-full service-card-anim card-entrance`}
