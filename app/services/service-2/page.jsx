...
const capabilityCards = [
  {
    ...
    titleClass: "min-[1025px]:w-[323px] min-[1025px]:h-[38px] text-[18px] font-semibold min-[1025px]:leading-[38px] text-[#212121] max-[1024px]:!w-[328px] max-[1024px]:!h-[38px] max-[1024px]:!text-[18px] max-[1024px]:!leading-[38px]",
    descClass: "min-[1025px]:w-[323px] min-[1025px]:h-[112px] text-[14px] leading-[28px] text-[#585858] max-[1024px]:!w-[328px] max-[1024px]:!h-[112px] max-[1024px]:!text-[14px] max-[1024px]:!leading-[28px]"
  },
  {
    id: "compliance",
    ...
    titleClass: "min-[1025px]:w-[323px] min-[1025px]:h-[38px] text-[18px] font-semibold min-[1025px]:leading-[38px] text-[#212121] max-[1024px]:!w-[328px] max-[1024px]:!h-[38px] max-[1024px]:!text-[18px] max-[1024px]:!leading-[38px]",
    descClass: "min-[1025px]:w-[323px] min-[1025px]:h-[140px] text-[14px] leading-[28px] text-[#585858] max-[1024px]:!w-[328px] max-[1024px]:!h-[112px] max-[1024px]:!text-[14px] max-[1024px]:!leading-[28px]"
  },
  {
    id: "continuity",
  ...
  },
  {
    ...
    cardClass: "min-[1025px]:!w-[428px] min-[1025px]:!h-[608px] min-[1025px]:!rounded-[20px] bg-[url('/images/pages/services/service-2/right-card-image.svg')] bg-cover bg-center !p-0 max-[1024px]:!w-[384px] max-[1024px]:!h-[608px] max-[1024px]:!rounded-[20px] max-[1024px]:!p-0", 
    contentClass: "absolute min-[1025px]:top-[383px] min-[1025px]:left-[15px] min-[1025px]:w-[397px] min-[1025px]:h-[209px] p-[24px_16px] min-[1025px]:!p-[28px_24px] bg-[#FFFFFF1A] backdrop-blur-[16px] min-[1025px]:rounded-[20px] flex items-start justify-start border border-white/10 max-[1024px]:top-[394px] max-[1024px]:left-[15px] max-[1024px]:!w-[353px] max-[1024px]:!h-[198px] max-[1024px]:!rounded-[20px] max-[1024px]:!p-[24px] max-[1024px]:!gap-[10px]",
    ...
    titleClass: "text-[18px] font-semibold min-[1025px]:leading-[24px] text-white antialiased text-left min-[1025px]:w-[341px] h-auto max-[1024px]:!w-[317px] max-[1024px]:!h-[38px] max-[1024px]:!text-[18px] max-[1024px]:!leading-[38px]",
    descClass: "text-[14px] min-[1025px]:leading-[24px] text-white/90 font-normal antialiased text-left min-[1025px]:w-[341px] h-auto max-[1024px]:!w-[317px] max-[1024px]:!h-[112px] max-[1024px]:!text-[14px] max-[1024px]:!leading-[28px]"
  }
];
...
const baseTitleClass = "font-sora text-[#212121] antialiased max-[425px]:!text-[18px] max-[375px]:!text-[16px] max-[320px]:!text-[15px]";
const baseDescClass = "font-manrope text-[#585858] antialiased max-[425px]:!text-[14px] max-[425px]:!leading-[24px] max-[375px]:!text-[13px] max-[320px]:!text-[12px]";
      ...
      <div className="w-full max-[1024px]:max-w-[425px] max-[1024px]:mx-auto bg-[#ffffff]">
        ...
        <section className="relative w-[1454px] h-[556px] left-[-3px] mx-auto flex flex-col justify-center items-center overflow-hidden bg-[url('/images/pages/services/service-2/service-2-hero-bg.svg')] max-[1024px]:!bg-[url('/images/pages/services/service-2/mobile-view-hero-bg%20.svg')] bg-cover bg-top bg-no-repeat bg-[#01060B] opacity-100 p-[100px_20px_60px] max-[1454px]:p-[160px_20px_100px] text-center max-[1024px]:!text-center max-[1024px]:!w-full max-[1024px]:!h-auto max-[1024px]:!aspect-[430/631] max-[1024px]:!pt-[75px] max-[1024px]:!pb-[60px] max-[425px]:!pt-[60px] max-[425px]:!pb-[40px] max-[1024px]:!px-[24px] max-[1024px]:!left-0">
          <div className="absolute min-[1025px]:top-[184px] min-[1025px]:left-1/2 min-[1025px]:-translate-x-1/2 min-[1025px]:w-[795px] min-[1025px]:h-[216px] flex flex-col items-center min-[1025px]:gap-[21px] z-[5] opacity-100 max-[1024px]:!relative max-[1024px]:!w-full max-[1024px]:!h-auto max-[1024px]:!top-0 max-[1024px]:!left-0 max-[1024px]:!gap-[21px] max-[1024px]:!items-center max-[1024px]:!mx-auto max-[1024px]:!mt-0">
            ...
            <div className="flex flex-col items-center min-[1025px]:gap-[10px] min-[1025px]:w-[795px] h-auto opacity-100 max-[1454px]:w-full max-[1454px]:h-auto max-[1024px]:!gap-[21px]">
              <h1 className="font-sora text-[40px] font-semibold text-[#ffffff] min-[1025px]:w-[795px] h-auto opacity-100 min-[1025px]:leading-[57px] text-center [text-wrap:balance] mx-auto max-[1024px]:!w-full max-[1024px]:!h-auto max-[1024px]:!text-[32px] max-[1024px]:!leading-[1.2] max-[1024px]:!text-center max-[1024px]:!mx-0 max-[425px]:!text-[28px] max-[375px]:!text-[24px] antialiased">
                Governance, Risk & Compliance (GRC)
              </h1>

              <p className="min-[1025px]:w-[795px] min-[1025px]:h-[90px] font-manrope font-normal text-[18px] leading-[30px] text-center text-[#EEEEEE] opacity-100 mx-auto antialiased max-[1024px]:!w-full max-[1024px]:!h-auto max-[1024px]:!text-[16px] max-[1024px]:!text-center max-[1024px]:!mx-auto max-[425px]:!text-[14px] max-[425px]:!leading-[24px]">
        ...
        <section className="p-[100px_20px_120px] bg-[#ffffff] max-[1024px]:!p-[60px_24px_10px] max-[425px]:!p-[40px_20px_10px] max-[1024px]:!overflow-hidden">
          <div className="w-[1230px] h-auto mx-auto flex flex-col gap-[44px] max-[1024px]:w-full max-[1024px]:max-w-[425px] max-[1024px]:px-0 max-[1024px]:mx-auto">
            <div className="flex justify-between items-start w-full min-[1025px]:w-[1230px] h-auto opacity-100 max-[1024px]:flex-col max-[1024px]:w-[384px] max-[1024px]:h-[215px] max-[1024px]:!gap-[9px] max-[1024px]:!mb-0">
              <h2 className="font-sora text-[32px] font-semibold text-[#212121] w-full min-[1025px]:w-[311px] h-auto min-[1025px]:h-[100px] leading-[50px] m-0 opacity-100 max-[1024px]:w-[289px] max-[1024px]:h-[86px] max-[1024px]:!text-[24px] max-[1024px]:!leading-[43px] antialiased">
                Empowering Your <br /> <span className="text-[#2E5A88]">Security Journey</span>
              </h2>
              <p className="font-manrope text-[16px] font-normal min-[1025px]:leading-[30px] text-[#585858] w-full min-[1025px]:w-[676px] h-auto min-[1025px]:h-[60px] m-0 opacity-100 max-[1024px]:w-[379px] max-[1024px]:h-[120px] max-[1024px]:!text-[16px] max-[1024px]:!leading-[30px] antialiased">
            ...
            <div className="flex flex-col min-[1025px]:flex-row gap-[24px] min-[1025px]:gap-[20px] w-full min-[1025px]:w-[1230px] h-auto opacity-100 max-[1024px]:w-[384px] max-[1024px]:h-[1868px] max-[1024px]:!gap-[23px] max-[1024px]:!items-center">
              ...
              {/* Column 2 (2 Cards) */}
              <div className="flex flex-col gap-[24px] w-full min-[1025px]:w-[379px] h-auto min-[1025px]:h-[608px]">
                {capabilityCards.slice(2, 4).map((card) => (
                  <article
                    key={card.id}
                    className={`${baseCardClass} ${card.cardClass || ""}`}
                  >
              ...
              <div className="w-full min-[1025px]:w-[428px] relative">
                <article
                  className={`${baseCardClass} ${capabilityCards[4].cardClass || ""} min-[1025px]:!h-[608px]`}
                >
