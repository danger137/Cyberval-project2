          ...
          <div className="flex flex-row items-stretch justify-center w-full max-w-[1173px] mx-auto gap-[17px] min-[1280px]:h-[545px] max-[1024px]:h-auto max-[1024px]:gap-[40px] max-[1024px]:flex-col max-[1024px]:items-center relative">
            ...
            <div className="flex flex-col gap-[17px] flex-1 max-w-[331px] w-full min-[1280px]:h-[545px] max-[1024px]:order-1">
              ...
              <article className="bg-[#F6F8FB] border-none rounded-[16px] p-[32px] text-left relative flex flex-col justify-center min-h-[250px] flex-1">
                 ...
                 <h3 className="font-sora text-[18px] font-bold text-[#212121] mb-[12px] mt-[40px]">What is a Virtual CISO?</h3>
                 <p className="font-manrope text-[18px] leading-[1.6] text-[#585858]">A vCISO gives you seasoned security leadership without the full-time executive hire, helping you turn cyber risk into a clear business plan.</p>
              </article>
              {/* Card 2 */}
              <article className="bg-[#F6F8FB] border-none rounded-[16px] p-[32px] text-left relative flex flex-col justify-center min-h-[250px] flex-1">
                 <div className="w-[52px] h-[52px] flex items-center justify-center absolute top-[24px] right-[24px]">
                 ...
                 <p className="font-manrope text-[18px] leading-[1.6] text-[#585858]">It is ideal when you need executive-level guidance, board communication, or a stronger roadmap but are not ready for a permanent CISO.</p>
              </article>
            </div>
            ...
            <div className="flex flex-col gap-[17px] flex-1 max-w-[331px] w-full min-[1280px]:h-[545px] max-[1024px]:order-3">
              ...
              <article className="bg-[#F6F8FB] border-none rounded-[16px] p-[32px] text-left relative flex flex-col justify-center min-h-[250px] flex-1">
                 ...
                 <h3 className="font-sora text-[18px] font-bold text-[#212121] mb-[12px] mt-[40px]">What it can include</h3>
                 <p className="font-manrope text-[18px] leading-[1.6] text-[#585858]">We can help with strategy, policy, compliance, vendor risk, incident readiness, and concise reporting that keeps leadership aligned.</p>
              </article>
              {/* Card 4 */}
              <article className="bg-[#F6F8FB] border-none rounded-[16px] p-[32px] text-left relative flex flex-col justify-center min-h-[250px] flex-1">
                 <div className="w-[52px] h-[52px] flex items-center justify-center absolute top-[24px] right-[24px]">
                 ...
                 <p className="font-manrope text-[18px] leading-[1.6] text-[#585858]">It is a strong fit for growth-stage teams, regulated organizations, and companies that need security leadership to scale with the business.</p>
              </article>
            </div>
          </div>
        </div>
