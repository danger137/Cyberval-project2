...
export default function VMPTaaSPage() {
  return (
    <div className="w-full min-h-screen bg-[#ffffff]">
      {/* Hero Section */}
      <section className="relative w-full min-[1025px]:h-[556px] h-auto min-h-[600px] mx-auto flex flex-col justify-center items-center overflow-hidden bg-[url('/images/pages/services/service-5/(VMPTaaS)/hero-bg.svg')] max-[1024px]:bg-[url('/images/pages/services/service-5/(VMPTaaS)/Frame%202147225646.svg')] bg-cover bg-top bg-no-repeat opacity-100 p-[120px_20px_60px] max-[1024px]:p-[140px_24px_80px] text-center">
        <div className="relative w-full max-w-[850px] flex flex-col items-center gap-[21px] text-center z-[5] px-[20px] mx-auto">
          ...
          <h1 className="font-sora text-[32px] max-[1024px]:text-[28px] max-[480px]:text-[24px] font-semibold text-[#ffffff] w-full max-w-[750px] opacity-100 leading-[1.3] text-center [text-wrap:balance] mx-auto m-0">
            Vulnerability Management & Penetration Testing as a Service (VMPTaaS)
          </h1>

          <p className="font-manrope font-normal text-[18px] max-[1024px]:text-[16px] leading-[1.6] text-[#EEEEEE] w-full max-w-[687px] opacity-100 text-center mx-auto m-0">
      ...
      {/* Why Choose Section */}
      <section className="p-[140px_20px_0px] max-[1024px]:p-[80px_24px_40px] bg-[#ffffff]">
        <div className="max-w-[1300px] mx-auto text-center">
          <h2 className="font-sora text-[32px] max-[1024px]:text-[26px] font-bold text-[#212121] mb-[30px]">
          ...
          <div className="flex flex-row items-stretch justify-center w-full max-w-[1173px] mx-auto gap-[17px] min-[1280px]:h-[545px] max-[1024px]:h-auto max-[1024px]:gap-[40px] max-[1024px]:flex-col max-[1024px]:items-center relative">
            ...
            <div className="flex flex-col gap-[17px] flex-1 max-w-[331px] w-full min-[1280px]:h-[545px] max-[1024px]:order-1">
              {/* Feature 1 */}
              <article className="bg-[#F6F8FB] border-none rounded-[16px] p-[32px] max-[480px]:p-[24px] text-left relative flex flex-col justify-center min-h-[250px] flex-1">
                 ...
                 <h3 className="font-sora text-[18px] max-[1024px]:text-[16px] font-bold text-[#212121] mb-[12px] mt-[40px]">What is VMPTaaS?</h3>
                 <p className="font-manrope text-[18px] max-[1024px]:text-[16px] leading-[1.6] text-[#585858]">VMPTaaS combines continuous vulnerability management with focused penetration testing so you can see risk, rank it, and validate what really matters.</p>
              </article>
              {/* Feature 2 */}
              <article className="bg-[#F6F8FB] border-none rounded-[16px] p-[32px] max-[480px]:p-[24px] text-left relative flex flex-col justify-center min-h-[250px] flex-1">
                 <div className="w-[52px] h-[52px] flex items-center justify-center absolute top-[24px] right-[24px]">
                 ...
                 <h3 className="font-sora text-[18px] max-[1024px]:text-[16px] font-bold text-[#212121] mb-[12px] mt-[40px]">Why it matters</h3>
                 <p className="font-manrope text-[18px] max-[1024px]:text-[16px] leading-[1.6] text-[#585858]">Threats change fast, and point-in-time testing misses a lot. Ongoing reviews keep remediation focused on the issues most likely to be exploited.</p>
              </article>
            </div>
            ...
            <div className="flex flex-col gap-[17px] flex-1 max-w-[331px] w-full min-[1280px]:h-[545px] max-[1024px]:order-3">
              ...
              <article className="bg-[#F6F8FB] border-none rounded-[16px] p-[32px] max-[480px]:p-[24px] text-left relative flex flex-col justify-center min-h-[250px] flex-1">
                 ...
                 <h3 className="font-sora text-[18px] max-[1024px]:text-[16px] font-bold text-[#212121] mb-[12px] mt-[40px]">How we work</h3>
                 <p className="font-manrope text-[18px] max-[1024px]:text-[16px] leading-[1.6] text-[#585858]">We scan, triage, and test on a schedule that fits your environment, then deliver clear remediation guidance and validation reports your teams can act on.</p>
              </article>
              {/* Feature 4 */}
              <article className="bg-[#F6F8FB] border-none rounded-[16px] p-[32px] max-[480px]:p-[24px] text-left relative flex flex-col justify-center min-h-[250px] flex-1">
                 <div className="w-[52px] h-[52px] flex items-center justify-center absolute top-[24px] right-[24px]">
                 ...
                 <h3 className="font-sora text-[18px] max-[1024px]:text-[16px] font-bold text-[#212121] mb-[12px] mt-[40px]">Who benefits</h3>
                 <p className="font-manrope text-[18px] max-[1024px]:text-[16px] leading-[1.6] text-[#585858]">It is a strong fit for teams that need regular security evidence, clearer prioritization, and a practical way to show progress across compliance or internal risk programs.</p>
              </article>
            </div>
          </div>
        </div>
