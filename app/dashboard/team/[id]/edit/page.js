    ...
    const fetchMember = async () => {
      try {
        ...
        if (response.ok) {
          ...
          alert(data.error || "Failed to fetch team member");
    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-x-3">
          ...
          <h2 className="text-3xl font-bold tracking-tight font-sora text-white">Edit Team Member</h2>
        </div>
      </div>
                ...
                {formData.image ? (
                  ...
                  <>
                    ...
                    <div className="text-center">
                      <p className="text-white font-medium">Change Profile Photo</p>
