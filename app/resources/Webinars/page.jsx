        ...
        <section className="p-[140px_20px_100px] bg-[#ffffff] max-[1024px]:!p-[80px_24px_60px] max-[425px]:!p-[60px_16px_40px]">
          <ScrollReveal direction="up">
            <div className="max-w-[1230px] mx-auto">
              <div className="grid grid-cols-3 gap-[24px] max-[1220px]:grid-cols-2 max-[1024px]:grid-cols-1 max-[1024px]:gap-y-[40px]">
                {filteredWebinars.length > 0 ? (
                  filteredWebinars.map((webinar, index) => (
                    <article 
                      key={webinar.id} 
                      className="flex flex-col group transition-all duration-300 webinar-card-anim"
                    ...
                    >
                      ...
                      <div className="p-[30px] flex flex-col flex-1 bg-[#FFFFFF] border border-[#E5E7EB] rounded-[24px] mt-[-30px] relative z-[1] max-[1024px]:p-[24px]">
                        ...
                        <p className="text-[18px] text-[#4A5568] mb-6 font-manrope leading-[28px] antialiased line-clamp-3">
                          {webinar.description}
                        </p>
