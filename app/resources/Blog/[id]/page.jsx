  ...
  return (
    <div className="w-full bg-[#ffffff]">
      <div className="w-full max-[1024px]:max-w-[440px] max-[1024px]:mx-auto bg-[#ffffff]">
        <div className="w-full pt-[150px] max-[1024px]:pt-[120px]">
          ...
          <section className="w-full bg-[#F3F7FC] py-[70px] max-[1024px]:py-[60px] mb-[100px] max-sm:mb-[50px]">
            <div className="max-w-[1224px] mx-auto px-[20px] max-[1024px]:px-[24px]">
              ...
              <div className="grid grid-cols-3 gap-[24px] max-[1220px]:grid-cols-2 max-[1024px]:grid-cols-1 max-[1024px]:!gap-[30px]">
                ...
                {/* Related Cards with New Design */}
                {[
                  { id: 2, title: "Navigating AI Regulations: What Companies Need to Watch", date: "Jan 15, 2026", img: "/images/pages/resources/Blog/blog-detail/card-1-image.svg" },
                  { id: 3, title: "The Future of Data Privacy in a Decentralized World", date: "Jan 12, 2026", img: "/images/pages/resources/Blog/blog-detail/card-2-image.svg" },
                  { id: 4, title: "Zero Trust: Why Your Perimeter is No Longer Enough", date: "Jan 08, 2026", img: "/images/pages/resources/Blog/blog-detail/card-3-image.svg" }
                ].map((item, idx) => (
                  <ScrollReveal key={item.id} direction="up" delay={idx * 0.1}>
                    <article className="bg-transparent overflow-visible flex flex-col group transition-all duration-300 w-full min-[1025px]:w-[378px] max-[1024px]:max-w-[378px] max-[1024px]:mx-auto">
                      ...
                      <div className="flex flex-col flex-1">
                        <span className="text-[14px] text-[#585858] mb-[8px] font-medium font-manrope">{item.date}</span>
                        ...
                        <div className="mt-auto pt-[10px] flex items-center">
                          <Link href={`/resources/Blog/${item.id}`} className="inline-flex items-center gap-[10px] cursor-pointer group/link">
