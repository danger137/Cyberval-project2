      ...
      <div className="w-full max-[1024px]:max-w-[440px] max-[1024px]:mx-auto bg-[#ffffff]">
        ...
        <section className="relative w-full h-[556px] min-[1025px]:w-[1440px] min-[1025px]:mx-auto max-[1024px]:h-[519px] flex flex-col justify-center items-center overflow-hidden bg-[url('/images/pages/resources/Blog/Frame%209%20(2).svg')] max-[1024px]:bg-[url('/images/pages/resources/Blog/Frame%202147225646%20(6).svg')] bg-cover bg-center bg-no-repeat bg-[#000F2E] opacity-100 p-[120px_20px_80px] max-[1024px]:!pt-[100px] max-[1024px]:!pb-[60px] max-[1024px]:!px-[24px] text-center blog-hero-fluid">
          <div className="relative w-full max-w-[850px] flex flex-col items-center gap-[24px] text-center z-[5] px-[20px] mx-auto hero-reveal max-[1024px]:!gap-[12px]">
            ...
            <h1 className="font-sora text-[40px] font-semibold text-[#ffffff] w-full max-w-[750px] opacity-100 min-[1025px]:leading-[57px] text-center [text-wrap:balance] mx-auto m-0 max-[1024px]:!text-[24px] max-[1024px]:!leading-[1.4] antialiased blog-hero-title-fluid">
              Blog
            </h1>
            ...
            <div className="grid grid-cols-3 gap-[19px] max-[1220px]:grid-cols-2 max-[1024px]:grid-cols-1 max-[1024px]:!gap-[30px]">
              {filteredBlogs.length > 0 ? (
                filteredBlogs.map((blog, index) => (
                  <article 
                    key={blog.id} 
                    className="bg-[#FFFFFF] border border-[#E5E7EB] rounded-[16px] overflow-hidden flex flex-col group transition-all duration-300 blog-card-anim card-entrance w-full min-[1025px]:w-[378px] min-[1025px]:h-[350px] max-[1024px]:max-w-[378px] max-[1024px]:mx-auto blog-card-fluid"
