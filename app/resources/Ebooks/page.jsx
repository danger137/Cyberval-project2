        ...
        <section className="p-[100px_20px_60px] bg-[#ffffff] max-[1024px]:!p-[60px_24px_40px]">
          <ScrollReveal direction="up">
            <div className="max-w-[1230px] mx-auto">
              <h2 className="font-sora text-[32px] font-semibold text-[#212121] mb-[40px] max-[1024px]:text-[28px] antialiased">
                Latest <span className="text-[#2E5A88]">Ebooks</span>
              </h2>
              <div className="grid grid-cols-3 gap-x-[50px] gap-y-[29px] max-[1024px]:grid-cols-1 max-[1024px]:gap-y-[40px]">
                {filteredEbooks.length > 0 ? (
                  filteredEbooks.map((ebook, index) => (
                    <article 
                      key={ebook.id} 
                      className="flex flex-col group transition-all duration-300 ebook-card-anim max-[1024px]:max-w-[378px] max-[1024px]:mx-auto w-full"
                    ...
                    >
                      ...
                      <div className="flex justify-between items-center pr-1">
                        ...
                        <Link href={`/resources/Ebooks/${ebook.id}`} className="flex-shrink-0 w-auto h-auto flex justify-center items-center transition-all duration-300 group/link">
                          <img 
                            src="/images/pages/resources/Ebooks/card-6-image.svg" 
                            alt="" 
                            width={32}
                            height={32}
                            style={{ width: '32px', height: '32px', minWidth: '32px', minHeight: '32px' }}
                            className="object-contain transition-transform duration-300 group-hover/link:translate-x-1" 
                          />
                        </Link>
                      </div>
                    </article>
